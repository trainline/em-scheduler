...
resource "aws_cloudwatch_event_rule" "every_three_minute" {
...
resource "aws_cloudwatch_event_target" "scheduler_cloudwatch_scheduled_trigger" {
  rule      = "${aws_cloudwatch_event_rule.every_three_minute.name}"
...
resource "aws_lambda_permission" "scheduler_cloudwatch_scheduled_trigger_permission" {
  ...
  source_arn    = "${aws_cloudwatch_event_rule.every_three_minute.arn}"
}
